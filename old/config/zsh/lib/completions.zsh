...
zstyle ':completion:*:descriptions' format              '%F{yellow}-- %d --%f'                      # Comment when using fzf-tab plugin. For more information, see https://github.com/Aloxaf/fzf-tab/issues/43.
